---
description: Read-only second-opinion code review via Cline (DeepSeek-V4-Flash). Inspects working-tree changes and reports findings with file:line citations and severity. Never edits files.
